...
type WasmCodegenOutput struct {
	...
	Files []WasmCodegenOutputFiles `json:"files"`
}

type WasmCodegenOutputFiles struct {
...
type preWasmCodegenOutput struct {
	Files Optional[[]preWasmCodegenOutputFiles] `json:"files,omitzero"`
}

// preWasmCodegenOutputFiles is the version of WasmCodegenOutputFiles previous to the required field validation
type preWasmCodegenOutputFiles struct {
	Path    Optional[string] `json:"path,omitzero"`
	Content Optional[string] `json:"content,omitzero"`
}

// validate validates the required fields of WasmCodegenOutputFiles
func (p *preWasmCodegenOutputFiles) validate() error {
	if p == nil {
		return errorMissingRequiredField("preWasmCodegenOutputFiles is nil")
	}
...
// transform transforms the preWasmCodegenOutputFiles type to the final WasmCodegenOutputFiles type
func (p *preWasmCodegenOutputFiles) transform() WasmCodegenOutputFiles {
	// Transformations
	transPath := p.Path.Value
	transContent := p.Content.Value

	// Assignments
	return WasmCodegenOutputFiles{
		Path:    transPath,
...
func (p *preWasmCodegenOutput) transform() WasmCodegenOutput {
	// Transformations
	var transFiles []WasmCodegenOutputFiles
	transFiles = make([]WasmCodegenOutputFiles, len(p.Files.Value))
	for i, v := range p.Files.Value {
		var tmp_ WasmCodegenOutputFiles
		tmp_ = v.transform()
		transFiles[i] = tmp_
	}
