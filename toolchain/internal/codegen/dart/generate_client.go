...
func generateCore(_ *ir.Schema, _ *flatSchema, _ *config.DartConfig) (string, error) {
...
func generateClient(_ *ir.Schema, flat *flatSchema, config *config.DartConfig) (string, error) {
	if !config.GenClient {
		return "", nil
	}
