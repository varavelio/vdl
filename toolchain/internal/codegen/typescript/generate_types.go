...
func generateTypes(schema *irtypes.IrSchema, cfg *config.TypeScriptConfig) (string, error) {
	...
	appendContent := func(g *gen.Generator, genFunc func(*irtypes.IrSchema, *config.TypeScriptConfig) (string, error)) error {
