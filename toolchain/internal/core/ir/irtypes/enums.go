...
func (e EnumValueType) MarshalJSON() ([]byte, error) {
	if !e.IsValid() {
		return nil, fmt.Errorf("cannot marshal invalid value %q for EnumValueType enum", string(e))
	}
...
func (e *EnumValueType) UnmarshalJSON(data []byte) error {
	...
	if !candidate.IsValid() {
		return fmt.Errorf("invalid value %q for EnumValueType enum", value)
	}
	*e = candidate
	return nil
}
...
func (e LiteralKind) MarshalJSON() ([]byte, error) {
	if !e.IsValid() {
		return nil, fmt.Errorf("cannot marshal invalid value %q for LiteralKind enum", string(e))
	}
	return json.Marshal(string(e))
}
...
func (e *LiteralKind) UnmarshalJSON(data []byte) error {
	...
	if !candidate.IsValid() {
		return fmt.Errorf("invalid value %q for LiteralKind enum", value)
	}
	*e = candidate
	return nil
}
...
func (e PrimitiveType) MarshalJSON() ([]byte, error) {
	if !e.IsValid() {
		return nil, fmt.Errorf("cannot marshal invalid value %q for PrimitiveType enum", string(e))
	}
	return json.Marshal(string(e))
}
...
func (e *PrimitiveType) UnmarshalJSON(data []byte) error {
	...
	if !candidate.IsValid() {
		return fmt.Errorf("invalid value %q for PrimitiveType enum", value)
	}
	*e = candidate
	return nil
}
...
func (e TypeKind) MarshalJSON() ([]byte, error) {
	if !e.IsValid() {
		return nil, fmt.Errorf("cannot marshal invalid value %q for TypeKind enum", string(e))
	}
	return json.Marshal(string(e))
}
...
func (e *TypeKind) UnmarshalJSON(data []byte) error {
	...
	if !candidate.IsValid() {
		return fmt.Errorf("invalid value %q for TypeKind enum", value)
	}
	*e = candidate
	return nil
}
