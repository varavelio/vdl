...
3. **Verification**:
   - **Code Generation (Golang, TypeScript, Dart)**: It executes the generated code using the respective runtime/tool:
     - Go: `go run .`
...
4. Add verification files:
   - For **Code**: A `main.go`, `main.ts`, or `main.dart` that uses the generated code and panics/fails on error.
